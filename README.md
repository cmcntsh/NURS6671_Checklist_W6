...
| **Dependent<br>(or Outcome)<br>Variable (DV)**<br><br> | **Nominal** | $\textcolor{red}{Add \ this \ test:}$ Chi-Square Test of Independence (Association) | $\textcolor{red}{Add \ this \ test:}$ Chi-Square Test of Independence (Association) |  |  |
| <br><br><br> | **Ordinal** | $\textcolor{red}{Add \ this \ test:}$ Chi-Square Test of Independence (Association) | $\textcolor{red}{Add \ this \ test:}$ Chi-Square Test of Independence (Association) |  |  |
| <br><br><br> | **Interval** |  |  |  |  |
| <br><br><br> | **Ratio** |  |  |  |  |
...
| Relevant descriptive statistics:<br>Name of test performed and null hypothesis:<br>Statistical test information:<br>Interpretation for the reader:<br> |
| **--------------------References--------------------** |
